...
<script src="{{base_url('assets/backend')}}/js/custom/whyus.js" type="text/javascript"></script>
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Why Us Update</h6>
    </div>
    <div class="card-body">
            ...
            <div class="col-12">
                <div class="form-group">
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <textarea name="content" id="intro_content">{{$whysus->content}}</textarea>
                        </div>
                    </div>
                </div>
