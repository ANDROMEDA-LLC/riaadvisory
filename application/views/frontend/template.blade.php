...
<head>
    ...
    <link rel="icon" href="{{base_url('assets/frontend')}}/img/ria_favicon.png" sizes="192x192" />
    <link rel="apple-touch-icon-precomposed" href="{{base_url('assets/frontend')}}/img/ria_favicon.png" />
    <meta name="msapplication-TileImage" content="{{base_url('assets/frontend')}}/img/ria_favicon.png" />
            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-6">
                        <p><span>Address:</span> <i class="flaticon-placeholder"></i> <a style="display: inline; color: #ffffff;" target="_blank" href="https://www.google.com/maps/place/2000+Ponce+de+Leon+Blvd+%23600,+Coral+Gables,+FL+33134,+Amerika+Birle%C5%9Fik+Devletleri/@25.7542806,-80.2612405,17z/data=!3m1!4b1!4m5!3m4!1s0x88d9b79942bc8b13:0xb488cf59f14014bf!8m2!3d25.7542806!4d-80.2590518">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <ul>
                            <li><span>Contact Phone:</span> <i class="flaticon-phone-call"></i> <a href="tel:3054216303">305.421.6303</a></li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="single-footer-widget">
                        ...
                        <ul class="footer-contact-list">
                            ...
                            <li>
                                <p style="color:#4ac728;">“A ISO 27001” AND “SOC2” CERTIFIED COMPANY</p>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="copyright-area" style="margin-top: 20px;">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                    <p style="font-size:12px !important;float:right"> Developed by <a href="https://www.andromeda.network/" target="_blank">Andromeda LLC.</a></p>
                    </div>
                </div>
            </div>
        </div>
