				...
				<div class="col-lg-4 col-md-6">
                        <div class="single-blog-post">
                            ...
                            <div class="entry-post-content">
                                ...
                                <h3><a href="#">Angular Developer</a></h3> 
                                <a href="#" class="learn-more-btn">Apply Now <i class="flaticon-add-1"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
					 ...
					 <div class="col-lg-4 col-md-6">
                        <div class="single-blog-post">
                            ...
                            <div class="entry-post-content">
                                ...
                                <h3><a href="#">Software Developer / Full Stack Developer ( Core JAVA/J2EE)</a></h3> 
                                <a href="#" class="learn-more-btn">Apply Now <i class="flaticon-add-1"></i></a>
                            </div>
                        </div>
                    </div>
					 <div class="col-lg-4 col-md-6">
                        <div class="single-blog-post">
                            ...
                            <div class="entry-post-content">
                                ...
                                <h3><a href="#">Senior Java Architect</a></h3> 
                                <a href="#" class="learn-more-btn">Apply Now <i class="flaticon-add-1"></i></a>
                            </div>
                        </div>
                    </div>
					<div class="col-lg-4 col-md-6">
                        <div class="single-blog-post">
                            ...
                            <div class="entry-post-content">
                                ...
                                <h3><a href="#">Oracle Revenue Management & Billing (ORMB) / Oracle CC&B / OUAF Techno-Functional</a></h3> 
                                <a href="#" class="learn-more-btn">Apply Now <i class="flaticon-add-1"></i></a>
                            </div>
                        </div>
                    </div>
					<div class="col-lg-4 col-md-6">
                        <div class="single-blog-post">
                            ...
                            <div class="entry-post-content">
                                ...
                                <h3><a href="#">DevOps / Release Engineer</a></h3> 
                                <a href="#" class="learn-more-btn">Apply Now <i class="flaticon-add-1"></i></a>
                            </div>
                        </div>
                    </div>
					<div class="col-lg-4 col-md-6">
                        <div class="single-blog-post">
                            ...
                            <div class="entry-post-content">
                                ...
                                <h3><a href="#">ORMB Solution Architect</a></h3> 
                                <a href="#" class="learn-more-btn">Apply Now <i class="flaticon-add-1"></i></a>
                            </div>
                        </div>
                    </div>
					<div class="col-lg-4 col-md-6">
                        <div class="single-blog-post">
                            ...
                            <div class="entry-post-content">
                                ...
                                <h3><a href="#">Senior Project manager</a></h3> 
                                <a href="#" class="learn-more-btn">Apply Now <i class="flaticon-add-1"></i></a>
                            </div>
                        </div>
                    </div>
