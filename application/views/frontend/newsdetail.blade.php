                    ...
                    <div class="col-lg-8 col-md-12">
                        <div class="blog-details">
                            <div class="article-image">
                                <img src="{{base_url('uploads/news/').$newsdetail->resim_yol}}" alt="image">
                            </div>

                            <div class="article-content">
                                <div class="entry-meta">
                                    <ul>
                                        <li><span>Posted On:</span> <a href="#">@php echo date('m-d-Y', strtotime(str_replace('-', '/', $newsdetail->create_date))) @endphp</a></li> 
                                        <li><span>Posted By:</span> <a href="#">Admin</a></li>
                                    </ul>
                                </div>
                                @php echo htmlspecialchars_decode($newsdetail->icerik) @endphp
                                   </div>
<!-- 
                    ...
                    <div class="col-lg-4 col-md-12">
                        <aside class="widget-area" id="secondary">
                            ...
                            <section class="widget widget_evolta_posts_thumb">
                                ...
                                <article class="item">
                                    <a href="{{base_url('newsdetail/').$item->slug}}" class="thumb">
                                        <span class="fullimage cover" role="img" ><img src="{{base_url('uploads/news/').$item->resim_yol}}"/></span>
                                    </a>
                                    <div class="info">
                                        <time datetime="2019-06-30">@php echo date('m-d-Y', strtotime(str_replace('-', '/', $item->create_date))) @endphp</time>
                                        <h4 class="title usmall"><a href="{{base_url('newsdetail/').$item->slug}}">{{$item->baslik}}</a></h4>
                                    </div>
